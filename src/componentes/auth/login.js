...
const Login = () => {
  ...
  <div className="bg-gray-100 flex justify-center items-center h-screen">
    ...
    <div className="w-1/2 h-screen hidden lg:block">
      <img src="https://i.ibb.co/Y3GKdC1/Conoce-nuestros-espacios-Co-working.jpg" alt="..." className="object-cover w-full h-full rounded-l-lg shadow-lg"  />
    </div>
    {/* Right: Login Form */}
    <div className="lg:p-36 md:p-52 sm:p-20 p-8 w-full lg:w-1/2 bg-white rounded-lg shadow-md">
      ...
      <form id="login-form">
        ...
        <div className="mb-5 flex items-center border-b border-yellow-500 pb-2">
          ...
          <input type="text" id="numero_documento" name="numero_documento" placeholder="Ingrese su número de documento" className="w-full border-0 focus:outline-none" autoComplete="off" />
        </div>
        {/* Password Input with Icon */}
        <div className="mb-5 flex items-center border-b border-yellow-500 pb-2">
          <i className="fas fa-lock text-yellow-500 mr-2" />
          <input type="password" id="contrasena" name="contrasena" placeholder="Ingrese su contraseña" className="w-full border-0 focus:outline-none" autoComplete="off" />
        </div>
        ...
        <button type="submit" className="bg-yellow-500 border border-black text-black font-semibold rounded-md py-2 px-4 w-full transition duration-150 ease-in-out hover:bg-yellow-600 hover:text-white">Acceder</button>
      </form>
      {/* Sign up Link */}
      <div className="mt-6 text-gray-900 text-center">
        <Link to="#a" className="hover:underline text-sm flex items-center justify-center">
