...
const BarraNormal = () => {
  ...
  return (
    <div>
        ...
        <title>Barra de navegación Normal</title>
      </div>
      ...
      <div className="flex flex-col items-center justify-center mb-24">
        <div className="flex flex-col">
          ...
          <nav className="navbar_gradient flex justify-between items-center py-4 backdrop-blur-md shadow-md w-full fixed top-0 left-0 right-0 z-10 h-24 px-8">
            {/* Logo Container */}
            ...
            <div
              id="mobile-menu-2"
              className="hidden lg:flex flex-col lg:flex-row lg:items-center lg:space-x-12 space-y-2 lg:space-y-0"
            >
              {/* Imagen para modo pequeño */}
              <img
                src="https://via.placeholder.com/150"
                alt="Imagen adicional"
                className="block lg:hidden mx-auto mb-2 opacity-0"
              />
              <Link
                to="/"
                className="flex items-center text-gray-900 hover:text-yellow-800 cursor-pointer font-semibold transition-colors duration-300"
              >
              ...
              <div className="relative">
                ...
                <div id="reservas-menu" className="dropdown-menu mt-2 rounded-lg shadow-lg bg-white">
                  <Link to="/reserva-local">Reserva local</Link>
                  <Link to="/reserva-mesa">Reserva mesa</Link>
                </div>
              </div>
              <Link
                to="/pedidos"
            ...
            <div className="flex items-center space-x-6">
              <Link
                to="/RegistroCliente"
                className="flex text-gray-600 hover:text-yellow-800 cursor-pointer transition-colors duration-300"
              >
                <svg
